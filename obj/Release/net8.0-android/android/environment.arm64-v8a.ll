...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3124790131054918449, ; hash 0x2b5d7c117f2cbb31, from name: aot-MiAppMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 77
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4654943606538048475, ; hash 0x4099ae8c152d13db, from name: MiAppMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 117
	...
	%struct.DSOCacheEntry {
		i64 5197109461475426465, ; hash 0x481fd7850e1080a1, from name: libaot-MiAppMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	%struct.DSOCacheEntry {
		i64 5198418367228087335, ; hash 0x48247df66c7f0c27, from name: libaot-MiAppMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 124
	...
	%struct.DSOCacheEntry {
		i64 9906206955489070449, ; hash 0x8979eabd9d6e0d71, from name: MiAppMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 250
	...
	%struct.DSOCacheEntry {
		i64 15443471390466285583, ; hash 0xd6523b6817a6a00f, from name: aot-MiAppMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MiAppMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 403
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7be54f31-f55e-454d-babf-eb0e9571ad86\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.miappmaui\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-MiAppMaui.dll.so\00", align 1
